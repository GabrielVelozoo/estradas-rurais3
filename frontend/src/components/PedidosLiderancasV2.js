            ...
            <div className="p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                  ...
                  <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded-lg">
                    ...
                    <p className="text-base font-semibold text-gray-900">
                      {new Date(selectedPedido.created_at).toLocaleDateString('pt-BR', {
                        ...
                        month: '2-digit',
                        year: 'numeric'
                      })} – {new Date(selectedPedido.created_at).toLocaleTimeString('pt-BR', {
                        hour: '2-digit',
                        minute: '2-digit'
                      })}h
                    </p>
                  ...
                  {/* Data de última edição com hora */}
                  <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-lg">
                    ...
                    <p className="text-base font-semibold text-gray-900">
                      {selectedPedido.updated_at && selectedPedido.updated_at !== selectedPedido.created_at ? (
                        <>
                          {new Date(selectedPedido.updated_at).toLocaleDateString('pt-BR', {
                            day: '2-digit',
                            month: '2-digit',
                            year: 'numeric'
                          })} – {new Date(selectedPedido.updated_at).toLocaleTimeString('pt-BR', {
                            hour: '2-digit',
                            minute: '2-digit'
                          })}h
                        </>
                      ) : (
                        <span className="text-gray-500 italic">Nunca editado</span>
                      )}
                    </p>
                  </div>
                </div>
