...
class PedidoLiderancaResponse(BaseModel):
    ...
    pedido_titulo: str = Field(default="", description="Título do pedido")
    protocolo: str = Field(default="", description="Protocolo no formato 00.000.000-0")
    nome_lideranca: str = Field(default="", description="Nome da liderança")
    numero_lideranca: str = Field(default="", description="Número da liderança")
    descricao: str = Field(default="", description="Descrição detalhada do pedido")
    created_at: str
    updated_at: str
